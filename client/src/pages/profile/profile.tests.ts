...
describe("Profile", () => {
    ...
    describe("OnLoad", () => {
        ...
        it("gets for profile by route id", async () => {
        ...
        it("displays notification when getting profile throws known failure", async () => {
        ...
        it("sets empty profile when getting profile throws known failure", async () => {
        ...
        it("redirects to notfound route when failure indictes profile not found", async () => {
        ...
        it("throws error when getting profile throws unknown failure", async () => {
