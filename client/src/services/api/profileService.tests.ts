...
describe("ProfileService", () => {
    ...
    describe("getProfile", () => {
        ...
        it("returns initialized UserProfile object", async () => {
            let id = "someIdValue";
        ...
        it("provides id to service", async () => {
        ...
        it("encodes id value for service", async () => {
            let spy = spyOn(http, "get").and.callThrough();
    ...
    describe("searchProfiles", () => {
        ...
        it("returns initialized ProfileResult objects", async () => {
            let filters = new Array<CategoryFilter>();
        ...
        it("searches all profiles when no filters provided", async () => {
            let spy = spyOn(http, "get").and.callThrough();
        ...
        it("searches profiles with single filter", async () => {
            let spy = spyOn(http, "get").and.callThrough();
        ...
        it("searches profiles with multiple filters", async () => {
            let spy = spyOn(http, "get").and.callThrough();
        ...
        it("encodes profiles with multiple filters", async () => {
            let spy = spyOn(http, "get").and.callThrough();
